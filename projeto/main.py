...
icon = pygame.image.load("graphics\icone-placeholder.png")
...
fonte = pygame.font.Font('fonts\Pixeltype.ttf', 50)
...
superficie_fundo = pygame.image.load('graphics/background-placeholder.jpg')
